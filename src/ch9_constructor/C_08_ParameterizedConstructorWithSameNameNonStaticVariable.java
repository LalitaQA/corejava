...
public class C_08_ParameterizedConstructorWithSameNameNonStaticVariable {
	...
	public static void main(String[] args) {
		...
		C_08_ParameterizedConstructorWithSameNameNonStaticVariable ref= new C_08_ParameterizedConstructorWithSameNameNonStaticVariable("3000 stritches", "sudha murthy");
